...
INSERT INTO `tbleventslist` (`id`,`name`,`theme`,`place`,`datefrom`,`dtaeto`,`event_id`) VALUES 
 (1,'intramurals','habang may oras may pag asa','sports complex','Saturday, August 18, 2018','',1);
...
INSERT INTO `tblstudentlist` (`id`,`fn`,`ln`,`level`,`strand`,`gender`,`contact`,`age`,`bdate`,`address`,`qrcode`) VALUES 
 (4,'Marcelito','Cosicol','Grade 12','TVL-ICT  B','Female','09686','17','11/22/2000','Bgy. Tagburos','cosicolmarcelito'),
 (5,'Junnel','Atun','Grade 12','TVL-ICT  B','Male','344','533','3535','Bgy. Tagburos','atunjunnel'),
 (6,'Ivan','Hamid','Grade 12','TVL-ICT  B','Male','0954','19','12','Bgy. Irawan','hamidivan'),
 (7,'mark','alfaro','Grade 12','TVL-ICT  B','Male','09897811234','18','12/30/2000','bgy.tagburos','alfaromark'),
 (8,'Julie','Dandal','Grade 12','TVL-ICT  B','Female','544','534534','543534','3453454','435345345345'),
 (9,'jon','Cosicol','fg','f','f','f','f','f','f','f');
