...

{
    ...
    public partial class Admin : Form
    {
        ...
        private void Searchs(string sSearchs)
        {
            ...
            int i = 1;
            string sql = "SELECT * FROM allss  WHERE fulln like '%" + sSearchs + "%' or  agency like '%" + sSearchs  + "%' or  date like '%" + sSearchs + "%' order by fulln ASC";
            sql_cmd = new MySqlCommand(sql, clsMySQL.sql_con);
            MySqlDataReader rd = sql_cmd.ExecuteReader();
            allss.Items.Clear();
            while (rd.Read())
        ...
        private void y1()
        {
            string sql = "INSERT INTO summary VALUES (null,'" + textBox1.Text + "','" + "Driver"+ "','" + lagen.Text + "','" + "0" + "',now())";
            MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
            cmd.ExecuteNonQuery();
        }
        private void y2()
        {
            string sql = "INSERT INTO summary VALUES (null,'" + textBox2.Text + "','" + "Tourguide" + "','" + lagen.Text + "','" + "0" + "',now())";
            MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
            cmd.ExecuteNonQuery();
        }
        private void y3()
        {
            string sql = "INSERT INTO summary VALUES (null,'" + textBox3.Text + "','" + "Tourguide" + "','" + lagen.Text + "','" + "0" + "',now())";
            MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
            cmd.ExecuteNonQuery();
        }
        private void y4()
        {
            string sql = "INSERT INTO summary VALUES (null,'" + textBox4.Text + "','" + "Tourguide" + "','" + lagen.Text + "','" + "0" +  "',now())";
            MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
            cmd.ExecuteNonQuery();
        }
        private void y5()
        {
            string sql = "INSERT INTO summary VALUES (null,'" + textBox5.Text + "','" + "Tourguide" + "','" + lagen.Text + "','" + "0" + "',now())";
            MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
            cmd.ExecuteNonQuery();
        }
 public void tr1()
 {
     ...
     string sql = "INSERT INTO allss VALUES (null,'" + na1 +  "','" + lagen.Text + "','" + tot.Text + "','" + label2.Text + "','" + label3.Text + "','" + label3.Text  + "','" + Picker1.Text + "')";
     MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
     cmd.ExecuteNonQuery();
 }
 ...
 public void tr2()
 {
     ...
     string sql = "INSERT INTO allss VALUES (null,'" + na2 + "','" + lagen.Text + "','" + tot.Text + "','" + label2.Text + "','" + label3.Text + "','" + label3.Text + "','" + Picker1.Text + "')";
     MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
     cmd.ExecuteNonQuery();
 }
 public void tr3()
 {
     ...
     string sql = "INSERT INTO allss VALUES (null,'" + na3 + "','" + lagen.Text + "','" + tot.Text + "','" + label2.Text + "','" + label3.Text + "','" + label3.Text + "','" + Picker1.Text + "')";
     MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
     cmd.ExecuteNonQuery();
 }
 public void tr4()
 {
     ...
     string sql = "INSERT INTO allss VALUES (null,'" + na4 + "','" + lagen.Text + "','" + tot.Text + "','" + label2.Text + "','" + label3.Text + "','" + label3.Text + "','" + Picker1.Text + "')";
     MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
     cmd.ExecuteNonQuery();
 }
 public void tr5()
 {
     ...
     string sql = "INSERT INTO allss VALUES (null,'" + na5 + "','" + lagen.Text + "','" + tot.Text + "','" + label2.Text + "','" + label3.Text + "','" + label3.Text + "','" + Picker1.Text + "')";
     MySqlCommand cmd = new MySqlCommand(sql, clsMySQL.sql_con);
     cmd.ExecuteNonQuery();
 }
