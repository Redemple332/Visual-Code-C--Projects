    ...
    public partial class USER : Form
    {
        ...
        private void messas()
        {
            ...
            while (rd.Read())
            {
                ...
                label18.Text = (rd["message"].ToString());
                label20.Text = (rd["date"].ToString());
                noti = (rd["message"].ToString());
            }
        ...
        private void ssssss_Click(object sender, EventArgs e)
        {
            string d;
            d = DateTime.Now.ToLongDateString();
